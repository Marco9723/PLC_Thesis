...
def main():
    ...
    # prediction_folder = "C:/Users/marco/Documents/GitHub/Packet_Loss_Concealment_Thesis/TESI/CODE/predictions"
    ...
    for audio_test_path in audio_test_folder.glob(audio_format):
        ...
        # PESQ
        pesq = pesq_metric(torch.tensor(y_pred_res), torch.tensor(y_ref_res)).cpu().numpy()
    ...
    print('plcmos_mean:',intrusive_mean)
    print('lsd_mean:', lsd_mean) 
    print('stoi_mean:', stoi_mean)
    print('pesq_mean:', pesq_mean)
