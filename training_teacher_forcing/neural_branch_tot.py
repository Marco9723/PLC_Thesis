...
class PLCModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        #nn_pred = torch.tensor(nn_pred[None, None, ...])
        ...
        # mse_loss= metr.nmse(y_pred=pred, y_true=target)
    ...
    def on_train_epoch_end(self):
        if self.current_epoch % self.train_dataset.packets_for_signal == 0:
            ...
            # self.epsilon = min(self.epsilon + (self.train_dataset.packets_for_signal / CONFIG.TRAIN.epochs), 1.0)
        else:
