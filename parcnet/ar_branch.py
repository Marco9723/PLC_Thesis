...
class ARModel:
    ...
    def autocorrelation_method(self, valid: np.ndarray) -> np.ndarray:
        # Compute the sample autocorrelation function (covariance)
        ...
        # Diagonal loading regularization to improve conditioning
        # Sempre invertibile, linearmente indipendenti
    ...
    def predict(self, valid: np.ndarray, steps: int) -> np.ndarray:
        ...
        #valid: passato 
        #steps: da predire
        #valid_zero_mean = valid - np.mean(valid)
